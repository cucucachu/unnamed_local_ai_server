...
- **Model**: Gemma 4 26B-A4B (MoE, 25.2B total / 3.8B active params, 8+1 experts, 256K context), Apache 2.0, GGUF checkpoints. Default quant is **Q4_K_M** (~13–14GB, fast), configurable to Q5_K_M/Q6_K/Q8_0 via a config swap.
